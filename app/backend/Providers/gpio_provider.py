try:
    ...
    class MockPWM:
        def __init__(self, pin, frequency):
            ...
            print(f"[GPIO_PROVIDER] [MockPWM] PWM initialized on pin {pin} at {frequency}Hz")

        def start(self, duty_cycle):
            print(f"[GPIO_PROVIDER] [MockPWM] PWM on pin {self.pin} started with duty cycle {duty_cycle}%")

        def ChangeDutyCycle(self, duty_cycle):
            print(f"[GPIO_PROVIDER] [MockPWM] PWM on pin {self.pin} changed to duty cycle {duty_cycle}%")
