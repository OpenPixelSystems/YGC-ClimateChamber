...
class RelayController(IRelayController):
    ...
    def initialize(self) -> None:
        ...
        print(f"[RelayController] [initialize] Initialized {len(self.relay_configs)} relay(s), fridge on pin {self.fridge_relay_pin}")
    ...
    def activate_fridge(self) -> None:
        ...
        print(f"[RelayController] [activate_fridge] Activating fridge relay on pin {self.fridge_relay_pin}")
    ...
    def deactivate_fridge(self) -> None:
        ...
        print(f"[RelayController] [deactivate_fridge] Deactivating fridge relay on pin {self.fridge_relay_pin}")
